...
<div id="container">
    <table id="table2">
        <tr>
            ...
            <td id="tanım7"><?php echo $_SESSION['re_ex1'];?></td>
        </tr>
        <tr>
            <td id="tanım8">Example Translate :</td>
            <td id="tanım7"><?php echo $_SESSION['re_ex1t'];?></td>
        </tr>
...
<div id="container">
    <table id="table2">
        ...
        <tr>
            <td id="tanım8">Example :</td>
            <td id="tanım7"><?php echo $_SESSION['re_ex2'];?></td>
        </tr>
        <tr>
            <td id="tanım8">Example Translate :</td>
            <td id="tanım7"><?php echo $_SESSION['re_ex2t'];?></td>
        </tr>
    </table>
</div>
<div id="container">
    <table id="table2">
        ...
        <tr>
            <td id="tanım8">Example :</td>
            <td id="tanım7"><?php echo $_SESSION['re_ex3'];?></td>
        </tr>
        <tr>
            <td id="tanım8">Example Translate :</td>
            <td id="tanım7"><?php echo $_SESSION['re_ex3t'];?></td>
        </tr>
    </table>
</div>
</body>
