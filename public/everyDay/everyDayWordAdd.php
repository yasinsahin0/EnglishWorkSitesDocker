...
<div id="container">
    <table id="table">
        <form action="control_everyday_word.php" method="post" enctype="multipart/form-data">
            <tr>
...
<form action="add_everyday_word.php" method="post" enctype="multipart/form-data">
<div id="container">
    <table id="table4">
        <tr>
            <td id="tanım">Word :</td>
