...
<div id="container">
    <table id="table">
        <form action="../php/control_vocabulary.php" method="post" enctype="multipart/form-data">
            <tr>
...
<form action="../php/add_vocabulary.php" method="post" enctype="multipart/form-data">
<div id="container">
    <table id="table4">
        <tr>
